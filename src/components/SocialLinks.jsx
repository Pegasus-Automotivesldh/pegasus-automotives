    ...
    <div id="contact" className="py-20 px-6 max-w-7xl mx-auto">
      ...
      <div className="text-center max-w-2xl mx-auto mb-16">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-[#28282C] bg-[#131315] mb-4">
          ...
          <span className="f-mono text-[10px] uppercase text-[#D8B45E]">
            Direct Communication
          </span>
        </div>

        <h2 className="f-display text-3xl sm:text-5xl font-light mb-4">
          Connect & Consult
        </h2>

        <p className="text-sm text-[#98969E] font-light">
          Reach out to our advisory team for personalized vehicle sourcing,
          factory allocations, or private showroom visits.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="pa-card p-6 sm:p-8 rounded-2xl">
            <h3 className="f-display text-xl font-light mb-6 text-[#F4F2EC]">
              Direct Channels
            </h3>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="overflow-hidden">
                        ...
                        <p className="text-[10px] text-[#6B6970] truncate">
                          {platform.handle}
                        </p>
                      </div>
                    </div>
                    ...
                    <ArrowUpRight
                      size={14}
                      className="text-[#6B6970] group-hover:text-[#D8B45E] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform"
                    />
                  </a>
                );
              })}
        ...
        <div className="lg:col-span-7">
          <div className="pa-card p-6 sm:p-10 rounded-2xl h-full flex flex-col justify-between">
            <div>
              <h3 className="f-display text-2xl font-light mb-2 text-[#F4F2EC]">
                Schedule a Consultation
              </h3>

              <p className="text-xs text-[#98969E] mb-8 font-light">
                Fill in your details below and an automotive specialist will
              ...
              {isSubmitted ? (
                <div className="p-8 border border-[#D8B45E]/30 bg-[#C9A227]/5 rounded-xl text-center my-auto">
                  ...
                  <p className="text-xs text-[#98969E]">
                    Thank you. A Pegasus Automotives advisor will get in touch
                    with you shortly.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block f-mono text-[10px] uppercase text-[#6B6970] mb-1.5">
                        Full Name
                      </label>
